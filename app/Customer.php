...
class Customer extends Model
{
    ...
    protected $fillable = ['id_customer','nama_customer','alamat_customer','tanggal_lahir','nomor_telepon','tanggal_tambah_customer_log','tanggal_ubah_customer_log','user_customer_log'];
