                    ...
                    <div class="panel">
                        ...
                        @csrf
                            <div class="panel-body">
                                ...
                                <input type="text" class="form-control @error('nomor_telepon_supplier') is-invalid @enderror" id="nomor_telepon_supplier" name="nomor_telepon_supplier" placeholder="Masukkan Nomor Telepon" value="{{old('nomor_telepon_supplier')}}">
