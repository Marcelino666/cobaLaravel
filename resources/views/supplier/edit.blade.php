                        ...
                        <div class="panel-body">
                            <form method="post" action="/supplier/{{$supplier->id_supplier}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nomor_telepon_supplier') is-invalid @enderror" id="nomor_telepon_supplier" name="nomor_telepon_supplier" placeholder="Masukkan Nomor Telepon" value="{{$supplier->nomor_telepon_supplier}}">
